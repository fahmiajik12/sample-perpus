                            ...
                            <?php foreach($data_buku as $buku) :?>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a class="btn btn-danger btn-xs" onclick="return confirm('Anda yakin akan menghapus data?');" href="delete-buku.php?id_buku=<?=$buku['buku_id'];?>"><i class="fa fa-trash-o"></i></a>
                                    </td>
                                </tr>
                            <?php endforeach ?>
                            </tbody>
